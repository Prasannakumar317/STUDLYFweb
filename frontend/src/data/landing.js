// Centralized constants for STUDLYF AI landing page
...
export const METRICS = [
  { value: 24000, suffix: "+", label: "Projects launched" },
  { value: 9800, suffix: "+", label: "Businesses planned" },
  { value: 120000, suffix: "+", label: "Strategies generated" },
  { value: 64, suffix: "+", label: "Countries served" },
];

export const TESTIMONIALS = [
  { name: "Ananya Verma", role: "Founder, Lumen Labs", quote: "STUDLYF AI rewrote our GTM in an afternoon. Investors finally got what we do.", rating: 5, avatar: "https://images.pexels.com/photos/33646670/pexels-photo-33646670.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=200&w=200" },
  { name: "Marcus Lee", role: "Partner, North Ventures", quote: "The VC Score saves my team hours on every diligence call. It's our new first read.", rating: 5, avatar: "https://images.pexels.com/photos/29852895/pexels-photo-29852895.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=200&w=200" },
  { name: "Priya Raman", role: "Head of Incubation, BITS", quote: "We onboarded 40 student startups in a week — every cohort report writes itself.", rating: 5, avatar: "https://images.pexels.com/photos/33646670/pexels-photo-33646670.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=200&w=200" },
];

export const PRICING = [
  {
    name: "Starter", monthly: 0, yearly: 0, badge: "Free forever",
    features: ["1 project", "5 AI generations / day", "Strategy basics", "Community support"],
    cta: "Start free",
  },
  {
    name: "Pro", monthly: 29, yearly: 24, badge: "Most popular", highlight: true,
    features: ["5 projects", "Unlimited AI strategy", "Brand + Marketing studio", "Pitch deck export", "Priority support"],
    cta: "Go Pro",
  },
  {
    name: "Business", monthly: 79, yearly: 64,
    features: ["20 projects", "All 10 agents", "VC Score + diligence", "White-label exports", "Dedicated success"],
    cta: "Start Business",
  },
  {
    name: "Enterprise", monthly: null, yearly: null, badge: "Custom",
    features: ["Unlimited projects", "Custom agents & SLA", "SSO & audit logs", "On-prem deploy", "Solutions architect"],
    cta: "Talk to sales",
  },
];

export const FAQ_ITEMS = [
  { q: "What exactly does STUDLYF AI do?", a: "STUDLYF AI is a complete business growth platform — it generates strategy, market research, branding, marketing assets, sales plans and investor-ready decks using a team of specialised AI agents." },
  { q: "Who is STUDLYF AI for?", a: "Founders, students, startup teams, incubators, accelerators, mentors, agencies, SMEs and investors. Each audience gets a tailored workspace." },
  { q: "Do I need any prior business knowledge?", a: "No. Our AI walks you from idea to launch with structured prompts and frameworks. You bring the vision — we bring the playbook." },
  { q: "How accurate is the market data?", a: "We blend live web research with curated knowledge bases and validated frameworks. Every insight is traceable and exportable." },
  { q: "Can I export my work?", a: "Yes — decks (PPTX/PDF/Google Slides), documents (DOCX/PDF), and dashboards (CSV/PNG)." },
  { q: "Is my data secure?", a: "All workspaces are isolated, encrypted at rest and in transit, and never used to train public models." },
];

export const BLOG_POSTS = [
  { title: "From idea to pitch deck in 47 minutes", excerpt: "How a solo founder used STUDLYF AI to land a pre-seed round.", tag: "Case study", img: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzd8MHwxfHNlYXJjaHwxfHxzdGFydHVwJTIwdGVhbSUyMG1vZGVybiUyMG9mZmljZSUyMG1pbmltYWx8ZW58MHx8fHwxNzgyNjMyMTAxfDA&ixlib=rb-4.1.0&q=85" },
  { title: "The new VC due-diligence stack", excerpt: "Why investors are flipping their first-read process around AI.", tag: "Insights", img: "https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzd8MHwxfHNlYXJjaHwyfHxzdGFydHVwJTIwdGVhbSUyMG1vZGVybiUyMG9mZmljZSUyMG1pbmltYWx8ZW58MHx8fHwxNzgyNjMyMTAxfDA&ixlib=rb-4.1.0&q=85" },
  { title: "10 strategy frameworks every founder needs", excerpt: "We rebuilt them as one-click AI prompts inside STUDLYF.", tag: "Playbook", img: "https://images.unsplash.com/photo-1556761175-b413da4baf72?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzd8MHwxfHNlYXJjaHwzfHxzdGFydHVwJTIwdGVhbSUyMG1vZGVybiUyMG9mZmljZSUyMG1pbmltYWx8ZW58MHx8fHwxNzgyNjMyMTAxfDA&ixlib=rb-4.1.0&q=85" },
];
